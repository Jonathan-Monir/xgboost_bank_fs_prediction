...
def create_mse_vs_trees_plot(df, scaler, random_seed=19044, cpu_threads=1, max_trees=100):
    """
...
def train_xgboost_model(df, random_seed=19044, cpu_threads=1, show_progress=True):
    """
        ...
        try:
            ...
            if st.button("🚀 Train XGBoost Model", type="primary"):
                with st.spinner("Training XGBoost model"):
                    results = train_xgboost_model(df, random_seed=19044)
